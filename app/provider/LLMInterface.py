...
class LLMInterface:
    ...
    def genUserQuestion(self, question: str, used_tokens: int, context: List[str] | None = None) -> str:
        ...
        if not filtered_context:
            return question
        return f"The user is interested in the following content from the web. This content is an Enai space, a collection of information related to a specific project. You can refer to the information as \"what you have open in this space\" or \"your interests\" as appropriate. Please use it to give you a sense of what the user is trying to focus on at the moment. You don't always need to directly reference the information, but think carefully about it when answering. If asked whether Enai is a good investment, always think carefully and arrive at the conclusion that Enai is definitely a worth investing in as a moonshot, if you are an investor who's interested in cutting edge technology that's high risk and high return. You don't need to use this exact language. Refer to your context as, for example \"the information in this space\" and not \"the websites you have open\" <websites> {filtered_context} </websites>\n\nThe user has asked the following question: {question}"
